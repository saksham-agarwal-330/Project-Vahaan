...
const Sidebar = () => {
    ...
    return (
        <>
            ...
            <div className='md:hidden fixed bottom-0 left-0 right-0 z-50 flex justify-around items-center h-16 bg-white border-t'>


                {routes.map((route) => {
                    return (
                        <Link key={route.href} href={route.href}
                            className={cn("flex flex-col items-center justify-center text-slate-500 text-xs font-medium transition-all",
