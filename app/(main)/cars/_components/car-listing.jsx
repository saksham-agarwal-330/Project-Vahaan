...
import CarListingsLoding from "./car-listings-loding";
...
const CarListings = () => {
  ...
  if (fetchingCars && !fetchCarData) {
    return <CarListingsLoding />;
  }

  if (fetchCarError || (!fetchCarData && !fetchCarData?.success)) {
  ...
  if (!fetchCarData || !fetchCarData?.data) {
    return null;
  }

  const { data: cars, pagination } = fetchCarData;
    ...
    return (
      <div className="min-h-[400px] flex flex-col items-center justify-center text-center p-8 border rounded-lg bg-gray-50">
        ...
        <p className="text-gray-500 mb-6 max-w-md">
          We couldn't find any cars matching your search criteria. Please try a
