    ...
    if (navigator.share) {
      navigator
        .share({
          ...
          text: `Check out this car: ${car.year} ${car.make} ${car.model}`,
        ...
        <div>
              ...
              <Card className="pt-5">
                <CardContent>
                  ...
                  <div className="text-xs text-gray-500 mt-1">
                    *Based on 15% down payment and 5% interest rate
                  </div>
                </CardContent>
              </Card>
            </DialogTrigger>
          ...
          {(car.status === "SOLD" || car.status === "UNAVAILABLE") && (
            <Alert variant="destructive">
              ...
              <AlertDescription>Plese check again later.</AlertDescription>
            </Alert>
          )}
          ...
          {car.status !== "SOLD" && car.status !== "UNAVAILABLE" && (
            <Button
              ...
              disabled={testDriveInfo?.userTestDrive && ["CONFIRMED", "PENDING"].includes(testDriveInfo.userTestDrive.status)}
              onClick={handleBookTestDrive}
            >
              <Calendar className="h-5 w-5 mr-2" />
              {testDriveInfo?.userTestDrive && ["CONFIRMED", "PENDING"].includes(testDriveInfo.userTestDrive.status)
                ? `Booked For ${format(
        ...
        <div className="bg-gray-50 rounded-lg p-6">
          <div className="flex flex-col md:flex-row gap-6 justify-between">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-medium">Vahaan Motors</h4>
