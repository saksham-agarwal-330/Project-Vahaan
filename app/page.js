    ...
    <div className="pt-20 flex flex-col">
      ...
      <section className="relative py-16 md:py-28 dotted-background">
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            <h1 className="text-5xl md:text-8xl mb-4 gradient-title">Find Your Dream car at Vahaan</h1>
            <p className="text-xl text-gray-500 mb-8 max-w-2xl mx-auto ">Find the best car that fits your budget</p>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold mb-3">Easy Test Drives</h3>
              <p className="text-gray-600">Book a text drive online in minutes,with flexible scheduling options.</p>
            </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {bodyTypes.map((bodyType) => {
              return (
                <Link key={bodyType.name} href={`/cars?bodyType=${bodyType.name}`} className="relative group cursor-pointer"
                >
                  <div className="overflow-hidden rounded-lg flex justify-end h-28 mb-4 relative">
                    <Image src={bodyType.image} alt={bodyType.name} fill
                      className="object-cover group-hover:scale-105 transition duration-300" />
                  </div>
                  <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent rounded-lg items-end">
                    <h3 className="text-white text-xl font-bold pl-4 pb-2">{bodyType.name}</h3>
                  </div>
                </Link>
              )
            })}
