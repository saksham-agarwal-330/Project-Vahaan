  ...
  return (
    <Card className="overflow-hidden hover:shadow-lg transition group py-0">
      <div className="relative h-48">
        ...
        <Button variant="ghost" size="icon" className={`absolute top-2 right-2 bg-white/90 ${isSaved?"text-red-500 hover:text-red-600":"text-gray-600 hover:text-gray-900"}`} onClick={handleToggleSave}>
